...
class _RegisterScreenState extends State<RegisterScreen>
{
  ...
  void authenticateSellerAndSignUp() async
  {
    ...
    await firebaseAuth.createUserWithEmailAndPassword(
      ...
      showDialog(
          ...
          {
            return ErrorDialog(
              message: "${error.message}Please use another email!",
            );
          }
      );
    });
  ...
  {
    //Create collection and save data on Firestore Database
    ...
    //save data locally or into the collection created above
